...
function Workouts({ apiHost }) {
  const codespaceApiEndpointTemplate = 'https://${import.meta.env.VITE_CODESPACE_NAME}-8000.app.github.dev/api/workouts/'
    ...
    <section>
      <div className="resource-header">
        <div>
          ...
          <p className="resource-subtitle">Endpoint: {`${apiHost}/api/workouts/`}</p>
